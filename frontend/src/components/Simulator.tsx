// Simulator.tsx
// Página del simulador de inversión funcional con Navbar, cálculos específicos por tipo de crédito y formato de moneda
...
const Simulator = () => {
  ...
  // Formateador de número sin símbolo de peso (solo para inputs visuales)
  ...
  if (capital > 0 && interes > 0 && plazo > 0) {
    switch (tipo) {
      ...
      case "Fidelidad": {
        // Se encapsula en bloque para permitir uso de const
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-4 animate-fade-in">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Formulario de simulación con inputs numéricos */}
          <form className="grid gap-6 sm:grid-cols-2 md:grid-cols-4">
            {/* Input Capital con formato visual de miles */}
            <div>
